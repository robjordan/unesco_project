...
urlpatterns = patterns(
    ...
    # /members/
    url(regex=r'^$',
        view=views.MemberListView.as_view(), name='list'),
    ...
    url(r'^password_change/$',
        ...
        kwargs={'post_change_redirect': 'members:password_change_done'},
    ...
    url(r'^password_reset/$', 'django.contrib.auth.views.password_reset',
        kwargs={'post_reset_redirect': 'members:password_reset_done'},
        name='password_reset'),
